...
set env(PERL5LIB) {}
exec "C:/Xilinx/10.1/ISE/bin/nt/unwrapped/xilperl.exe" "C:/Xilinx/10.1/DSP_Tools/common/bin/../../sysgen/scripts/probeclk.pl" -f ./netgen/map/senior_project_final_3_9_cw_map.v
vlog ./netgen/map/senior_project_final_3_9_cw_map.v
