...
set env(PERL5LIB) {}
exec "C:/Xilinx/10.1/ISE/bin/nt/unwrapped/xilperl.exe" "C:/Xilinx/10.1/DSP_Tools/common/bin/../../sysgen/scripts/probeclk.pl" -f ./netgen/translate/senior_project_final_3_9_cw_translate.v
vlog ./netgen/translate/senior_project_final_3_9_cw_translate.v
