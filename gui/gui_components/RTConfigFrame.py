...
class RTConfigFrame(wx.Dialog):
    def __init__(self, parent):
        ...
        self.ce_freq_label = wx.StaticText(self, -1, "Adjust Mixer Frequency")
        self.ce_freq_slider = wx.Slider(self, -1, 0, -5000000, 5000000)
        self.ce_freq_spin_ctrl = wx.SpinCtrl(self, -1, "0", min=-5000000, max=5000000)
        self.bw_label = wx.StaticText(self, -1, "Bandwidth of Processed Audio (kHz)", style=wx.ALIGN_CENTRE)
        self.bw_slider = wx.Slider(self, -1, 25, 1, 30)
        self.bw_spin_ctrl = wx.SpinCtrl(self, -1, "25", min=1, max=30)
        ...
        self.speaker_checkbox = wx.CheckBox(self, -1, "Output Audio to Speakers? (Experimental)")
        ...
        self.Bind(wx.EVT_SPINCTRL,self.OnSpinMixer, self.ce_freq_spin_ctrl)
        self.Bind(wx.EVT_SPINCTRL,self.OnSpinBW, self.bw_spin_ctrl)
        self.Bind(wx.EVT_SCROLL,self.OnSlideMixer,self.ce_freq_slider)
        self.Bind(wx.EVT_SCROLL,self.OnSlideBW,self.bw_slider)
    ...
    def __set_properties(self):
        ...
        #self.save_audio_checkbox.SetValue(1)
    ...
    def OnSpinMixer(self, event):
        self.ce_freq_slider.SetValue(self.ce_freq_spin_ctrl.GetValue())

    def OnSpinBW(self, event):
        self.bw_slider.SetValue(self.bw_spin_ctrl.GetValue())

    def OnSlideMixer(self, event):
        self.ce_freq_spin_ctrl.SetValue(self.ce_freq_slider.GetValue())

    def OnSlideBW(self, event):
        self.bw_spin_ctrl.SetValue(self.bw_slider.GetValue())
