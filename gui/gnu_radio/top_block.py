...
# Title: Top Block
# Generated: Fri Aug  5 14:35:00 2011
##################################################
...
class top_block(grc_wxgui.top_block_gui):
	...
	def __init__(self):
		...
		self.gr_file_sink_0 = gr.file_sink(gr.sizeof_short*1, "/home/phil/fx2lib-git/cactus")
		self.gr_file_sink_0.set_unbuffered(False)
		self.gr_file_source_0 = gr.file_source(gr.sizeof_short*1, "/home/phil/SDR_JOVE/gui/removeme.dat", False)
	...
	def set_samp_rate(self, samp_rate):
		...
		self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate/4, 1000000, 100000, firdes.WIN_RECTANGULAR, 6.76))
