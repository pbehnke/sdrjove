...
; endpoint 1 out
	...
	.db	0x82				;  ep1 dir=out and address
...
; endpoint 1 in 
	.db	DSCR_ENDPOINT_LEN
	.db	DSCR_ENDPOINT_TYPE
	.db	0x02				;  ep1 dir=in and address
	.db	ENDPOINT_TYPE_BULK	; type
	.db	0x00				; max packet LSB
	.db	0x02				; max packet size=512 bytes
	.db	0x00				; polling interval
...
; endpoint 4 out
	.db	DSCR_ENDPOINT_LEN
	.db	DSCR_ENDPOINT_TYPE
	.db	0x06				;  ep4 dir=OUT and address
	.db	ENDPOINT_TYPE_BULK	; type
	.db	0x00				; max packet LSB
	.db	0x02				; max packet size=512 bytes
	.db	0x00				; polling interval
...
; endpoint 6 in
	...
	.db	0x00				; max packet LSB
	.db	0x14				; max packet size=512 bytes
...
; endpoint 8 in
	.db	DSCR_ENDPOINT_LEN
	.db	DSCR_ENDPOINT_TYPE
	.db	0x02				;  ep8 dir=in and address
	.db	ENDPOINT_TYPE_ISO	; type
	.db	0x00				; max packet LSB
	.db	0x14				; max packet size=512 bytes
	.db	0x01				; polling interval
...
; endpoint 8 in
	.db	DSCR_ENDPOINT_LEN
	.db	DSCR_ENDPOINT_TYPE
	.db	0x82				;  ep8 dir=in and address
	.db	ENDPOINT_TYPE_ISO	; type
	.db	0x00				; max packet LSB
	.db	0x04				; max packet size=512 bytes
	.db	0x01				; polling interval
; alt 6
	.db	DSCR_INTERFACE_LEN
	.db	DSCR_INTERFACE_TYPE
...
; endpoint 8 in
	...
	.db	DSCR_ENDPOINT_LEN
	.db	DSCR_ENDPOINT_TYPE
	.db	0x06				;  ep8 dir=in and address
	.db	ENDPOINT_TYPE_ISO	; type
	.db	0x00				; max packet LSB
	.db	0x04				; max packet size=512 bytes
	.db	0x01				; polling interval
...
; endpoint 2 out
	...
	.db	0x03				; max packet size=64 bytes
	.db	0x01				; polling interval
...
; endpoint 4 out
	.db	DSCR_ENDPOINT_LEN
	.db	DSCR_ENDPOINT_TYPE
	.db	0x02				;  ep4 dir=OUT and address
	.db	ENDPOINT_TYPE_ISO	; type
	.db	0xff				; max packet LSB
	.db	0x03				; max packet size=64 bytes
	.db	0x01				; polling interval
